...
int main(){
    ...
    int pos3 = lower_bound(num,num+6,target)-num;
    int pos4 = upper_bound(num,num+6,target)-num;
    ...
    cout<<"系统实现lower_bound:\t "<<pos3<<" "<<num[pos3]<<endl;
    cout<<"upper_bound 第一个大于num的数字，找到返回该数字的地址\n";
    cout<<"我的实现upper_bound:\t "<<pos2<<" "<<num[pos2]<<endl;
    cout<<"系统实现upper_bound:\t "<<pos4<<" "<<num[pos4]<<endl;
    return 0;
}
